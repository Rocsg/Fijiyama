...
import ij.IJ;
import ij.ImagePlus;
import net.imagej.fijiyama.common.ItkImagePlusInterface;
import net.imagej.fijiyama.common.VitiDialogs;
import net.imagej.fijiyama.common.VitimageUtils;
import net.imagej.fijiyama.registration.CenteringStrategy;
import net.imagej.fijiyama.registration.IterationUpdate;
import net.imagej.fijiyama.registration.ItkRegistration;
import net.imagej.fijiyama.registration.ItkTransform;
import net.imagej.fijiyama.registration.MetricType;
import net.imagej.fijiyama.registration.OptimizerType;
import net.imagej.fijiyama.registration.SamplingStrategy;
